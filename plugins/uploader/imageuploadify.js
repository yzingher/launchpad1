...
(function ($, window, document, undefined) {
	...
	$.fn.imageuploadify = function (opts) {
		...
		this.each(function () {
			...
			let totalFiles = [];
			let counter = 0;
			let dragbox = $(`<div class="imageuploadify well"><div class="imageuploadify-overlay"></div><div class="imageuploadify-images-list text-center"><i class="fa fa-cloud-upload"></i><span class='imageuploadify-message'>Drag & drop CAD file anywhere or</span><button type="button"class="btn btn-outline-primary">or select file to upload</button></div></div>`);
			...
			button.mouseenter(function onMouseEnter(event) {
				button.css("background", "#007bff").css("color", "white");
			}).mouseleave(function onMouseLeave() {
				button.css("background", "white").css("color", "#007bff");
			});
